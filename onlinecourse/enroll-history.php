...
if(isset($_GET['del']))
{
mysqli_query($con,"delete from courseenrolls where id = '".$_GET['id']."'");
echo '<script>alert("Student RegistrationHistory Successfully !!")</script>';
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"> Enroll Registration History  </h1>
                    </div>
                </div>
                <div class="row" >
