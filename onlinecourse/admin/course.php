...
$ret=mysqli_query($con,"insert into course(courseCode,ResearchTopicName,FacultyName,noofSeats) values('$coursecode','$coursename','$courseunit','$seatlimit')");
if($ret)
{
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="coursename" name="coursename" placeholder="Research Topic Name" required />
  </div>

<div class="form-group">
    <label for="courseunit">Faculty Name  </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Faculty Name" required />
  </div> 
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['ResearchTopicName']);?></td>
